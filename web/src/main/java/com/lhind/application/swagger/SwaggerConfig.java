...
import static com.lhind.application.swagger.SwaggerConstant.*;
...
public class SwaggerConfig {
    ...
    public Docket apiDocket() {
        return new Docket(SWAGGER_2).apiInfo(apiInfo())
                ...
                .build()
                .tags(new Tag(USER_API_TAG, "All APIs relating to Users"))
                .tags(new Tag(FLIGHT_API_TAG, "All APIs relating to Flights"))
                .tags(new Tag(TRIP_API_TAG, "All APIs relating to Trips Waiting For Approval"))
                .tags(new Tag(USER_TRIP_API_TAG, "All APIs relating to a User's Trips"))
                .tags(new Tag(TRIP_FLIGHT_API_TAG, "All APIs relating to a Trip's Flight"))
                .tags(new Tag(LOGOUT_API_TAG, "All APIs relating to User Logout"));
    }
