...
class UserTripServiceImplTest {
    ...
    void canFindTripById() {
        ...
        //when
        //then
        assertDoesNotThrow(() -> underTest.findById(loggedUsername, tripId));
    }
    ...
    void canFindApprovedTrip() {
        ...
        //then
        assertDoesNotThrow(() -> underTest.findApprovedTrip(loggedUsername, tripId));
    }
    ...
    void canFindAllTripFilterByStatus() {
        ...
        //when
        //then
        assertDoesNotThrow(() -> underTest.findAllFilteredTrips(loggedUsername, tripFilterDto));
    }
